...
type
  ...
  archivoNovelas = file of reg_novela;
  
procedure leerArchivo (var arch_novelas: archivoNovelas; var nov: reg_novela);
begin
...
procedure mostrar (nov: reg_novela);
begin
...
procedure modificar (var nov: reg_novela);
begin
...
procedure leerNovela (var nov: reg_novela);
begin
...
procedure crearArchivoYcargarlo (var arch_novelas: archivoNovelas);
var
  cabecera, nov: reg_novela;
...
begin
  ...
  leerNovela (nov);
  while (nov.codigo <> 0) do  //en un comienzo no voy a tener reg borrados
    begin
      write (arch_novelas, nov);
      leerNovela (nov);
    end;
...
BEGIN
{
	...
	assign (arch_novelas, 'archivo_novelas'); //hago esto para 'agilizar', para respetar la consig tiene que hacerse {}
	opc := menuOpciones ();
    case opc of
      1: crearArchivoYcargarlo (arch_novelas);
